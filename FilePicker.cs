...
namespace Dull
{
    public class FilePicker
    {
        ...
        public static FilePicker GetFolderPicker(object o, string startingPath, string searchFilter, bool onlyAllowFolders)
            => GetFilePicker(o, startingPath,searchFilter,onlyAllowFolders);
