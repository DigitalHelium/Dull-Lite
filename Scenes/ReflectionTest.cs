...
namespace Dull.Scenes
{
    internal class ReflectionTest:BaseScene
    {
        public ReflectionTest(float ratio)
        {
            ...
            _list.AddHittable(new TriangleMT(new Vector3(-2, 0, -2), new Vector3(-2, 2, -2), new Vector3(2, 2, -2), false, red));
            _list.AddHittable(new TriangleMT(new Vector3(-2, 0, -2), new Vector3(2, 0, -2), new Vector3(2, 2, -2), false, red));
