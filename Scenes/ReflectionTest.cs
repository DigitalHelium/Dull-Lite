...
namespace Dull.Scenes
{
    public class ReflectionTest:BaseScene
    {
        public ReflectionTest(float ratio)
        {
            ...
            //_list.AddHittable(new TriangleMT(new Vector3(-2, 0, -2), new Vector3(-2, 2, -2), new Vector3(2, 2, -2), new Vector3(0, 0, 0), new Vector3(0, 1, 0), new Vector3(1, 1, 0), false, red));
