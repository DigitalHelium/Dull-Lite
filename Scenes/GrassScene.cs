...
namespace Dull.Scenes
{
    class GrassScene:BaseScene
    {
        public GrassScene(float ratio)
        {
            ...
            _camera = new Camera(ratio, 56.0f, new Vector3(-1.5f, 2, 3), new Vector3(-1.25f, 1.65f, 2),1);
            ...
            Lambertian checker1 = new Lambertian(new CheckerPattern(new Vector3(0.0f, 1.0f, 0.0f), new Vector3(1)));
            ...
            _list.AddHittable(new Sphere(new Vector3(0, -100.5f, -1), 100f, checker1));
